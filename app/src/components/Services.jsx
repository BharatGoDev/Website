...
export default function Services() {
  return (
    <section id="services">
      <div className="w-full pt-1 sm:h-[20vh] sm:w-full xl:h-[40vh] bg-clip-content bg-transparent shadow-2xl ">
        <h2 className="text-2xl font-bold tracking-tight text-white">
          Our Services
        </h2>
        <Carousel slideInterval={3000}   leftControl=" "
            rightControl=" " className="first-div">
  ...
  <img src="./app-services.svg" alt="..." className="relative h-1/2  w-full object-contain pt-2" />
  <br/>
  <span className="text-white">
  <p className="font-bold pt-2">App Development</p><br /> We specialize in creating cool and
...
<div className=" relative h-full w-full py-2" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
  ...
  <span className="text-white">
  <p className="font-bold pt-2">Web Development</p> <br /> We are really good at making websites that
          ...
          <div className="relative  h-full w-full  py-2" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            /><br/>
            <span className="text-white">
            <p className="font-bold pt-2">Graphic Design</p><br /> We love making things look awesome, like
        ...
        <Carousel slideInterval={3000} leftControl=" "
            rightControl=" " className="carousel-hidden pt-10">
  ...
  <div className=" relative h-3/4 w-full pt-4" >
    <img src="./website-services.svg" alt="..." className="relative h-1/2 w-full object-contain " />
    <span className="text-white pt-20">
    <p className="font-bold pt-2">Web Development</p> <br /> We are really good at making websites that
      look great and work well. We use the latest tech to make sure
      everything runs smoothly. Plus, we customize our solutions to fit
